...
declare module '$env/static/private' {
	...
	export const npm_package_postcss_plugins_postcss_preset_env_stage: string;
	...
	export const npm_package_prettier_trailingComma: string;
	...
	export const npm_config____config_npm_npmrc: string;
	...
	export const npm_package_postcss_modules: string;
	export const npm_package_devDependencies_postcss_nested: string;
	export const npm_config____cache_npm: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_prettier_tabWidth: string;
		...
		ZSH: string;
		PNPM_HOME: string;
		npm_package_postcss_plugins_postcss_preset_env_stage: string;
		USER: string;
		NVM_DIR: string;
		COMMAND_MODE: string;
		...
		npm_package_prettier_trailingComma: string;
		npm_execpath: string;
		PAGER: string;
		...
		npm_config____config_npm_npmrc: string;
		...
		INFOPATH: string;
		LC_TERMINAL: string;
		npm_package_postcss_modules: string;
		npm_package_devDependencies_postcss_nested: string;
		npm_config____cache_npm: string;
		COLORTERM: string;
